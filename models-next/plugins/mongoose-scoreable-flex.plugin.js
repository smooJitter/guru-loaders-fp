...
/**
 * @module mongoose-scoreable-flex.plugin
 * @description Adds a referenced scores array to a schema, supporting async scoring and user tracking.
 * @param {Schema} schema - The Mongoose schema to enhance.
 * @param {Object} [options]
 * @example
 * schema.plugin(mongooseScoreableFlexPlugin, { field: 'scores', scoreModel: 'Score' });
 */
