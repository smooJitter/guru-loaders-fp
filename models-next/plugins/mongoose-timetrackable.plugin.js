/**
 * @module mongoose-timetrackable.plugin
 * @description Adds a timeline array to track events (created, updated, etc.) with user and note support.
 * @param {Schema} schema - The Mongoose schema to enhance.
 * @param {Object} [options]
 * @example
 * schema.plugin(mongooseTimetrackablePlugin, { field: 'timeline' });
 */
