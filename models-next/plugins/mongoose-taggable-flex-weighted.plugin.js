/**
 * @module mongoose-taggable-flex-weighted.plugin
 * @description Adds weighted tags (embedded or referenced) to a schema, with sorting and normalization.
 * @param {Schema} schema - The Mongoose schema to enhance.
 * @param {Object} [options]
 * @example
 * schema.plugin(mongooseTaggableFlexWeightedPlugin, { field: 'tags', embedded: true });
 */
