# Action Loader Examples

This guide shows full `.action.js` file examples for `action-loader`, each featuring 3–4 actions and demonstrating different supported export patterns. All examples are self-contained and follow best practices.
