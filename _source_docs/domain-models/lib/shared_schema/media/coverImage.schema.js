...
const ImageSizeTC = schemaComposer.createObjectTC({
  name: 'ImageSize',
  description: 'Image size variant with dimensions and URL',
  fields: {
    width: 'Int!',
    height: 'Int!',
    url: 'String!',
...
const FocalPointTC = schemaComposer.createObjectTC({
  name: 'FocalPoint',
  description: 'Focal point coordinates for image cropping (0-1 range)',
  fields: {
    x: 'Float!',
    y: 'Float!'
  }
...
const ImageStorageTC = schemaComposer.createObjectTC({
  name: 'ImageStorage',
  description: 'Storage information for the image',
  fields: {
    provider: 'String!',
    bucket: 'String',
    path: 'String',
...
const CoverImageTC = schemaComposer.createObjectTC({
  name: 'CoverImage',
  description: 'Cover or profile image with multiple size variants',
  fields: {
    original: ImageSizeTC,
    small: ImageSizeTC,
    medium: ImageSizeTC,
    large: ImageSizeTC,
    sizes: [ImageSizeTC],
    ...
    caption: 'String',
    attribution: 'String',
    focalPoint: FocalPointTC,
    storage: ImageStorageTC,
    mimeType: 'String',
    uploadedAt: 'Date',
    isPrimary: 'Boolean',
    status: 'String'
